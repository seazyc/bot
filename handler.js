...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'hanya dapat digunakan owner',
        owner: 'hanya dapat digunakan owner',
        mods: 'hanya dapat digunakan moderator*',
        premium: 'only member premium',
        group: 'hanya dapat digunakan di grup',
        private: 'hanya dapat digunakan dichat pribadi',
